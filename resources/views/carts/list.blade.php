...
// echo "<pre>"; print_r($tempProducts);exit;
?>
@extends('main')
                    ...
                    <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                        <div class="m-l-25 m-r--38 m-lr-0-xl">
                                ...
                                <table class="table-shopping-cart">
                                    ...
                                    ?>
                                        <tr class="table_row">
                                            ...
                                            <td class="column-4">
                                                <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                                    ...
                                                    <input class="mtext-104 cl3 txt-center num-product" type="number"
                                                           name="num_product[{{ $product->id }}]" value="{{ $tempProducts[$product->id] }}">
                                            ...
                                            <td class="p-r-15">
                                                <a href="{{ route('cartsDelete.shop' , $product->id) }}">Xóa</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                            ...
                            <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                                ...
                                <input type="submit" value="Update Cart" formaction="{{url('UpdateCarts/shop')}}"
